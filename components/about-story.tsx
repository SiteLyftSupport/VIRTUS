  ...
  return (
    ...
    >
      <motion.div style={{ y: heroY }} className="absolute inset-0 -z-10">
        ...
        />
        <div className="absolute inset-0 bg-gradient-to-b from-[#07080b]/50 via-[#07080b]/85 to-[#07080b]" />
      ...
      <div className="relative mx-auto max-w-7xl px-6 pt-40 pb-24 lg:px-10 lg:pt-48 lg:pb-32">
        ...
        >
          <div className="lg:col-span-7">
            ...
            <h1 className="font-[var(--font-tactical)] text-balance text-5xl font-medium leading-[1.0] tracking-tight sm:text-4xl lg:text-[52px]">
              A small business
    ...
    <section className="relative overflow-hidden border-t border-white/5 bg-[#07080b] py-28 lg:py-40">
      ...
      <div className="relative mx-auto max-w-4xl px-6 lg:px-10">
        ...
        >
          ...
          <blockquote className="mt-2 font-[var(--font-tactical)] text-balance text-3xl font-medium leading-[1.15] tracking-tight text-[#f5f4ef] sm:text-4xl lg:text-5xl">
            ...
            the outcome the day they walk on."
          </blockquote>
          <figcaption className="mt-8 flex flex-wrap items-center gap-4 font-[var(--font-mono)] text-[11px] uppercase tracking-[0.28em] text-[#d4ae5b]">
    ...
    <section className="relative overflow-hidden border-t border-white/5 bg-[#07080b] py-24 lg:py-32">
      <div className="relative mx-auto max-w-4xl px-6 text-center lg:px-10">
        <motion.div
          ...
          transition={{ duration: 0.7, ease }}
        >
          <h3 className="font-[var(--font-tactical)] text-balance text-3xl font-medium leading-[1.1] tracking-tight text-[#f5f4ef] sm:text-4xl lg:text-5xl">
