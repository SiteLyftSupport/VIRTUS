      ...
      <div className="relative mx-auto max-w-7xl px-6 pt-40 pb-24 lg:px-10 lg:pt-48 lg:pb-32">
        ...
        >
          <div className="lg:col-span-7">
            ...
            <h1 className="font-[var(--font-tactical)] text-balance text-5xl font-extrabold leading-[1.0] tracking-tight sm:text-4xl lg:text-[52px]">
              A small business
    ...
    <section className="relative overflow-hidden border-t border-white/5 bg-[#07080b] py-28 lg:py-40">
      ...
      <div className="relative mx-auto max-w-4xl px-6 lg:px-10">
        ...
        >
          ...
          <blockquote className="mt-2 font-[var(--font-tactical)] text-balance text-3xl font-extrabold leading-[1.15] tracking-tight text-[#f5f4ef] sm:text-4xl lg:text-5xl">
